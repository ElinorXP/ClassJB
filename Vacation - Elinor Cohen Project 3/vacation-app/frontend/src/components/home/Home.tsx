...
const Home = () => {
    ...
    const showVacations = async () => {
        try{
            const response = await api.get(`/vacations?followedMode=${followedMode}&page=${currentPage}&rowsPerPage=${rowsPerPage}`);
    ...
    useEffect(() => {
        showVacations();
    }, [currentPage, rowsPerPage, followedMode]);
    ...
    const FollowingFilter = () => {
        ...
        }}>{followedMode ? "Show All" : "My Vacations"}</Button>}</>);
    }
